<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>قائمة الحجوزات </a>
                </li>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>اضافة حجز </a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>قائمة الغرف</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>اعدادات الحجز</a>
                </li>

                <li> <a href="#"><i class='bx bx-radio-circle'></i>اعدادات الموقع</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>All Testimonial</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>فئات المدونة </a>
                </li>

                <li> <a href="#"><i class='bx bx-radio-circle'></i>منشورات المدونة</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>جميع التعليقات </a>
                </li> 
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>تقرقر الحجز </a>
                </li> 
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>جميع الصور </a>
                </li> 
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i> رسائل التواصل </a>
                </li> 
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>جميع الادوار </a>
                </li> 
                <li> <a href="#"><i class='bx bx-radio-circle'></i>كل الادوار </a>
                </li> 

                <li> <a href="#"><i class='bx bx-radio-circle'></i>الاذونات  </a>
                </li>

                <li> <a href="#"><i class='bx bx-radio-circle'></i>جميع الاذونات </a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class='bx bx-radio-circle'></i>كل المديرين </a>
                </li> 
                <li> <a href="#"><i class='bx bx-radio-circle'></i>كل المديرين </a>
                </li> 
